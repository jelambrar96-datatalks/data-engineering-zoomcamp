...
To configure the New York timezone in a Kestra Schedule trigger, you should:
Add a timezone property set to `America/New_York` in the Schedule trigger configuration. 
By default, Kestra schedules use UTC. To use a specific local time that accounts for Daylight Saving Time changes, you must provide a valid TZ database name such as `America/New_York`. 
